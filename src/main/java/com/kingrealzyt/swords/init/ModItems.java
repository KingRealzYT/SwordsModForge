...
import com.kingrealzyt.swords.essence.EssenceBase;
...
public class ModItems {
    ...
    public static final RegistryObject<SwordItem> BLACK_IRON_SWORD = ITEMS.register("black_iron_sword", () ->
            new BlackIronSword(ModItemTier.BLACK_IRON, 0, -2.4F, new Item.Properties().tab(Swords.SWORDSTAB)));
    public static final RegistryObject<SwordItem> BLOOD_IRON_SWORD = ITEMS.register("blood_iron_sword", () ->
            new BloodIronSword(ModItemTier.BLOOD_IRON, 0, -2.4F, new Item.Properties().tab(Swords.SWORDSTAB)));
    public static final RegistryObject<SwordItem> FIRE_SWORD = ITEMS.register("fire_sword", () ->
            new FireSword(ModItemTier.FIRE, 0, -2.4F, new Item.Properties().tab(Swords.SWORDSTAB)));
    public static final RegistryObject<SwordItem> CRIMSON_SWORD = ITEMS.register("crimson_sword", () ->
            new CrimsonSword(ModItemTier.CRIMSON, 0, -2.4F, new Item.Properties().tab(Swords.SWORDSTAB)));
    public static final RegistryObject<SwordItem> COBALT_SWORD = ITEMS.register("cobalt_sword", () ->
            new CobaltSword(ModItemTier.COBALT, 0, -2.4F, new Item.Properties().tab(Swords.SWORDSTAB)));
    public static final RegistryObject<SwordItem> SILVER_SWORD = ITEMS.register("silver_sword", () ->
            new SilverSword(ModItemTier.SILVER, 0, -2.4F, new Item.Properties().tab(Swords.SWORDSTAB)));
    public static final RegistryObject<SwordItem> BRUH_SWORD = ITEMS.register("bruh_sword", () ->
            new BruhSword(ModItemTier.BRUH, 0, -2.4F, new Item.Properties().tab(Swords.SWORDSTAB)));
    public static final RegistryObject<SwordItem> HELL_IRON_SWORD = ITEMS.register("hell_iron_sword", () ->
            new HellIronSword(ModItemTier.HELL, 0, -2.4F, new Item.Properties().tab(Swords.SWORDSTAB)));
    public static final RegistryObject<SwordItem> ENDER_SWORD = ITEMS.register("ender_sword", () ->
            new EnderSword(ModItemTier.ENDER, 0, -2.4F, new Item.Properties().tab(Swords.SWORDSTAB)));

    // Combined Swords
    public static final RegistryObject<SwordItem> VAMPIRIC_SWORD = ITEMS.register("vampiric_sword", () ->
            new VampiricSword(ModItemTier.VAMPRIC, 0, -2.4F, new Item.Properties().tab(Swords.SWORDSTAB)));
    public static final RegistryObject<SwordItem> INFESTED_SWORD = ITEMS.register("infested_sword", () ->
            new InfestedSword(ModItemTier.INFESTED, 0, -2.4F, new Item.Properties().tab(Swords.SWORDSTAB)));
    public static final RegistryObject<SwordItem> HELL_BENDER_SWORD = ITEMS.register("hell_bender_sword", () ->
            new HellBenderSword(ModItemTier.HELL_BENDER, 0, -2.4F, new Item.Properties().tab(Swords.SWORDSTAB)));

    // Final Swords
    public static final RegistryObject<SwordItem> HOLY_SWORD = ITEMS.register("holy_sword", () ->
            new HolySword(ModItemTier.HOLY, 0, -2.4F, new Item.Properties().tab(Swords.SWORDSTAB)));
